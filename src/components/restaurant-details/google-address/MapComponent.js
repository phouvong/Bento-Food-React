...
import { GoogleMap, useJsApiLoader, Marker, MarkerF, InfoWindowF, OverlayView } from "@react-google-maps/api";
...
const MapComponent = ({
                          latitude, longitude,
                          data, handleRouteToRestaurant,
                          customMapStyle, resLat, resLong,
                          isRestaurant,
                          userLong, userLat
                      }) => {
