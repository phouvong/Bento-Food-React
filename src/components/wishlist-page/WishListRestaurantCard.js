...
const WishListRestaurantCard = ({
    ...
    const { name, cover_photo_full_url, logo, id, rating_count, address, slug, zone_id } = restaurant
        ...
        <WishlistBox sx={{ cursor: 'pointer' }}>
            <Grid container item md={12} xs={12} spacing={{ xs: 1 }} onClick={routeToRestaurant}>
                ...
                <Grid item md={4} sm={4} xs={4} >
                    <CustomImageContainer src={imageUrl} alt={name} maxWidth="120px" smMaxWidth="80px" height="120px" smHeight="80px" objectFit="cover" borderRadius=".7rem" smWidth="80px" />
                </Grid>
