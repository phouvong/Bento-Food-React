...
import { useTopPicksNearYouRestaurants } from '@/hooks/react-query/restaurants/useTopPicksNearYouRestaurants'
...
const SPACING = HOME_SECTION_SPACING.topPicksNearYou
...
const TopPicksNearYou = () => {
    ...
    const { isLoading, data } = useTopPicksNearYouRestaurants()
    ...
    const items = useMemo(() => data?.restaurants ?? [], [data])
...
export default memo(TopPicksNearYou)
