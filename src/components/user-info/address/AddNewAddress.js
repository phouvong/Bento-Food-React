                    ...
                    >
                        ...
                        >
                            ...
                            <RTL direction={languageDirection}>
                                <CustomStackFullWidth sx={{position:"relative"}} flexDirection={{ xs: "column", sm: "row" }} gap={{ xs: "10px", md: "15px" }}>
                                    <MapWithSearchBox rerenderMap={rerenderMap} coords={coords} orderType={orderType} mapHeight="200px" />
                                    <IconButton
                                        sx={{
