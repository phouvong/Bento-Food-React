...
import { ButtonGroup, Grid, NoSsr, Popover, Typography, useMediaQuery } from "@mui/material";
        ...
        <NoSsr>
            <Grid container spacing={{ xs: 1, sm: 3, md: 2 }}>
                ...
                <Grid item xs={12} sm={12} md={12} align="left" mt="0rem">
                    <CustomStackFullWidth direction="row"
                                          justifyContent={catetoryMenus?.length > 0 ? "space-between" : "flex-end"}
                                          alignItems="center">
                        {catetoryMenus?.length > 0 &&
                            <FoodNavigation
                                ...
                                id={id}
                            />}
                        {catetoryMenus?.length > 0 && !isSmall &&  <FilterButton
                            id="fade-button"
                            handleClick={handleDropClick}
                            //activeFilters={activeFilters}
